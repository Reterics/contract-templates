                        ...
                        <div className="space-y-4 md:space-y-6" style={{
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email"
                                       ...
                                       className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@integrint.hu" />
                            </div>
                            <div>
                            ...
                            <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                ...
                                <button
                                    onClick={() => SignUp({email, password} as UserFormValues)}
                                    className="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign up</button>
                            </p>
                        </div>
                    </div>
                </div>
